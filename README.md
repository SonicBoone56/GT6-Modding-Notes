...
Two very important numbers you'll be referencing a lot are **ID** and **UseCar/CarID**. **ID** is the number for the individual column (ie br_xj13_gts_66_a being **ID** 16375). **CarID** is the number that every part and table will use to reference itself to said car. If you forget or use the wrong number for this, bad things can happen!
...
# BRAKE
Configures the brakes the cars use. Every car has to have a default brake. Category 0 is stock brakes, Category 1 is racing brakes.
